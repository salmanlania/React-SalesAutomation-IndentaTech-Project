    ...
    return (
        <div className="containing">
            ...
            <form action="#" method="post">
                ...
                <div className="form-group">
                    ...
                    <div className="icon-input">
                        ...
                        >
                            ...
                            />
                            <path
                                d="M12 11.5C15.0376 11.5 17.5 14.4624 17.5 17.5H6.5C6.5 14.4624 8.96243 11.5 12 11.5Z"
                                stroke="currentColor"
                                strokeWidth={2}
                            />
                            <path
                                d="M2 21V20C2 16.6863 5.31371 14 8.5 14H15.5C18.6863 14 22 16.6863 22 20V21"
                                stroke="currentColor"
                                strokeWidth={2}
                            />
                        </svg>
                ...
                <div className="form-group ">
                    <label className="checkbox" style={{ gap: 2 }}>
                        <input type="checkbox" name id />
                        <span>
                            I want to receive news, trends, offers, or blogs by email.
                        </span>
                    </label>
                </div>
                <div className="form-group">
                    <p className="agreement">
                        By creating an account, you agree to our <span>Terms</span> and have
                        read and acknowledge the <span>Global Privacy Statement.</span>
                    </p>
                </div>
                <div
